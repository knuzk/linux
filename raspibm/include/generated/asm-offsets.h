...
#define TSK_ACTIVE_MM 1200 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 1376 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 6624 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_KEYS_USER 7592 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 7672 /* offsetof(struct task_struct, thread.keys_kernel) */
...
#define TRAMP_VALIAS -4322246656 /* TRAMP_VALIAS */
